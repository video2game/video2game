		...
		root.traverse((child) => {
			if (child.hasOwnProperty('userData') && child.userData.hasOwnProperty('data'))
			{
				if (child.userData.data === 'spawn')
				{
					...
					{	
						child.position.x = this.world.character_spawn.position_x;
						child.position.y = this.world.character_spawn.position_y;
						child.position.z = this.world.character_spawn.position_z;
						child.scale.x = this.world.character_spawn.scale_x;
						child.scale.y = this.world.character_spawn.scale_y;
						child.scale.z = this.world.character_spawn.scale_z;

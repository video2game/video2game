...
export class Character extends THREE.Object3D implements IWorldEntity
{
	...
	public accelarate_frames: number = 0;
	...
	constructor(gltf: any)
	{
		...
		// this.characterCapsule.body.linearDamping = 99999;
		// this.characterCapsule.body.angularDamping = 99999;
	...
	public inputReceiverInit(): void
	{
		...
		this.world.cameraOperator.setRadius(8.0, true);
